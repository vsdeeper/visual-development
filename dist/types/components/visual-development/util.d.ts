 ...
 * @returns
 */
export declare function findParentComponentOfComponent(target: MergeDesignData, designData: MergeDesignData[]): any;
/**
 * 拍平所有组件
 * @param data
 * @returns
 */
export declare function toFlattenComponents(data?: MergeDesignData[]): any[];
/**
 * 遍历组件列表
 * @param data
 * @param callback
 ...
 * @returns
 */
export declare function isRowComponent(data: ActiveDesignData): any;
/**
 * 判断组件是否是布局-col组件
 * @param data
 * @returns
 */
export declare function isColComponent(data: ActiveDesignData): any;
/**
 * 找到col在row中的索引
 * @param data
 * @param designData
 * @returns
 */
export declare function findIndexColInRow(data: RowColDesignData, designData: MergeDesignData[]): any;
/**
 * 生成设计数据id
 * @param type
 */
